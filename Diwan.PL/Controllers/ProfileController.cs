...
namespace Diwan.PL.Controllers
{
    public class ProfileController : Controller
    {
        ...
        public ProfileController(UserManager<DiwanUser> userManager, IUnitOfWork unitOfWork, IMapper mapper)
        {
        ...
        public async Task<IActionResult> Profile([FromRoute] string id)
        {
            ...
            var ProfileUser = await _unitOfWork.UserRepository.FindFirstAsync(U => U.Id == id);
            if (ProfileUser is not null)
            {
                ...
                var MappedProfile = new UserProfileViewModel()
                {
                    ...
                    Id = id,
                    Bio = ProfileUser.Bio,
                    CoverPicURL = ProfileUser.CoverPicURL,
